...
Vecr[-1] = -1*Vecr[-1] #try positive just in case
s0 = 0.1*np.ones(ny)
...
if (toPlot):
    ...
    plt.plot(xtrueP[0,:ifails[0]+1],xtrueP[1,:ifails[0]+1])
    ax = plt.gca()
    ax.set_aspect('equal')
    ...
    plt.plot(xSamps,yConeU)
    plt.plot(xVertSamps,yVertSamps)
    plt.plot(xtrueP[0,ifails[0]+1:ifails[0]+20],xtrueP[1,ifails[0]+1:ifails[0]+20])
    ax = plt.gca()
    ax.set_aspect('equal')
    plt.show()
    ...
    x1p.plot(xTime,xtrueP[0,:nsim+1])
    x1p.plot(xTime,xestO[0,:nsim+1])
    x2p.plot(xTime,xtrueP[1,:nsim+1])
    x2p.plot(xTime,xestO[1,:nsim+1])
    x3p.plot(xTime,xtrueP[2,:nsim+1])
    x3p.plot(xTime,xestO[2,:nsim+1])
    x4p.plot(xTime,xtrueP[3,:nsim+1])
    x4p.plot(xTime,xestO[3,:nsim+1])
    d1p.plot(xTime,noiseStored[0,:nsim+1])
    d1p.plot(xTime,xestO[4,:nsim+1])
    d2p.plot(xTime,noiseStored[1,:nsim+1])
    d2p.plot(xTime,xestO[5,:nsim+1])
    plt.show()
    ...
    plt.figure(5)
    plt.plot(np.abs(xtrueP[0,:nsim+1]-rx)+np.abs(xtrueP[1,:nsim+1]-ry),np.abs(xtrueP[0,:nsim+1]-rx)+np.abs(xtrueP[1,:nsim+1]-ry))
    plt.plot(np.abs(xtrueP[0,:nsim+1]-rx)+np.abs(xtrueP[1,:nsim+1]-ry),np.reshape(xv1n[0,:nsim+1], nsim+1))
    plt.show()